...
public class Vuelta {
	/**
	 * Ejercicio para trabajar con String
	 * @param args
	 */
	...
	public static void main(String[] args) {// es un array con cada palabra de nuestra frase
		...
		/**
		 * Recorre una frase desde la línea de comando y darle la vuelta
		 */
		...
		/**
		 * hace lo mismo, pero va dejando los caracteres de una String, volvandola al final
		 */
		...
		/**
		 * sin utilizar lenght calcular longitud
		 */
		...
		/**
		 * igual que el anterior pero sin calcular la longitud
		 */
